    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold">Créer un nouvel hébergement</h1>
          <p className="text-muted-foreground">
            Créez une nouvelle propriété
          </p>
        </motion.div>
        ...
        <Card>
          ...
          <CardContent>
            <PropertyForm property={null} onSuccess={handleSuccess} onCancel={handleCancel} />
          </CardContent>
        </Card>
      </div>
    </AdminLayout>
