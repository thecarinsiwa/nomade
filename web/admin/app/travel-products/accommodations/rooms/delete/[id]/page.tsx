    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-destructive">Supprimer la chambre</h1>
          <p className="text-muted-foreground">
            Confirmez la suppression de la chambre
          </p>
        </motion.div>
        ...
        <Card className="border-destructive">
          <CardHeader>
            ...
            <CardDescription>
              Cette action est irréversible. La chambre et toutes ses données associées seront définitivement supprimées.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                <p className="font-medium">{room.name || room.room_number || "Chambre"}</p>
                <p className="text-sm text-muted-foreground">
                  Propriété: {room.property_name || "-"} | Type: {room.room_type_name || "-"} | Capacité: {room.max_guests || room.capacity || "-"} personnes
                </p>
              </div>
            </div>
