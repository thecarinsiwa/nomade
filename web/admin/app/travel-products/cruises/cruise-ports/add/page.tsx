...
export default function AddCruisePortPage() {
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold">Nouveau port</h1>
              <p className="text-muted-foreground">
                Créez un nouveau port de croisière
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <Card>
          ...
          <CardContent>
            <CruisePortForm cruisePort={null} onSuccess={handleSuccess} onCancel={handleCancel} />
          </CardContent>
        </Card>
      </div>
    </AdminLayout>
