    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold">Créer une nouvelle croisière</h1>
          <p className="text-muted-foreground">
            Créez une nouvelle croisière
          </p>
        </motion.div>
        ...
        <Card>
          ...
          <CardContent>
            <CruiseForm cruise={null} onSuccess={handleSuccess} onCancel={handleCancel} />
          </CardContent>
        </Card>
      </div>
    </AdminLayout>
