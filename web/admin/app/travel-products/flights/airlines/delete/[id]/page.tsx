...
export default function DeleteAirlinePage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsDeleting(true)
      await airlinesService.delete(airline.id)
      toast({
        title: "Succès",
        description: "Compagnie aérienne supprimée avec succès",
      })
      router.push("/travel-products/flights/airlines")
    } catch (error) {
      toast({
    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-destructive">Supprimer la compagnie aérienne</h1>
        ...
        <Card className="border-destructive">
          <CardHeader>
            ...
            <CardDescription>
              Cette action est irréversible. La compagnie aérienne sera définitivement supprimée.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Code: {airline.code} {airline.country && `| Pays: ${airline.country}`}
                </p>
              </div>
            </div>
