...
export default function DeleteRewardPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsDeleting(true)
      await onekeyRewardsService.deleteReward(reward.id)
      toast({
        title: "Succès",
    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-destructive">Supprimer la récompense</h1>
          <p className="text-muted-foreground">
            Confirmez la suppression de la récompense
          </p>
        </motion.div>
        ...
        <Card className="border-destructive">
          <CardHeader>
            ...
            <CardDescription>
              Cette action est irréversible. La récompense sera définitivement supprimée.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Type: {reward.reward_type} | Compte: {reward.onekey_account_number || reward.onekey_account}
                </p>
              </div>
            </div>
