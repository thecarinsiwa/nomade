    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold">Créer une nouvelle récompense</h1>
          <p className="text-muted-foreground">
            Créez une nouvelle récompense pour un compte OneKey
          </p>
        </motion.div>
        ...
        <Card>
          ...
          <CardContent>
            <RewardForm reward={null} onSuccess={handleSuccess} onCancel={handleCancel} />
          </CardContent>
        </Card>
      </div>
    </AdminLayout>
