# Generated by Django 4.2.7 on 2025-11-26 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='payments.paymentstatus')),
            ],
            options={
                'db_table': 'payments',
                'ordering': ['-created_at'],
